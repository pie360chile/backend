...
-- Misma estructura que doc 31, con language_14, language_15 y mathematics_12.
-- Ejecutar en la base de datos MySQL (pie360).

CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_second_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 32,
  ...
  course VARCHAR(255) NULL COMMENT 'e.g. 2º básico',
  ...
  -- IV. Language & communication (15 indicators for 2º)
  ...
  -- V. Mathematics (12 indicators for 2º)
