...
CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_fifth_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 35,
  ...
  course VARCHAR(255) NULL COMMENT 'e.g. 5to basico',
