...
-- Normalized table, all columns in English. Run on MySQL database pie360.

CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_first_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 31,
  ...
  course VARCHAR(255) NULL COMMENT 'Course name as text (e.g. 1º básico)',
  report_date DATE NULL,
  repetitions VARCHAR(255) NULL,
  professional_id INT NULL COMMENT 'ID of the professional',
  report_type VARCHAR(50) NULL COMMENT 'anual | en_proceso',

  -- II. Situación escolar actual: JSON with all strength checkboxes (selected and empty); observations separate
  school_situation_strengths TEXT NULL COMMENT 'JSON: strength_creative, strength_autonomous, ... boolean',
  observations TEXT NULL,

  -- III. Attitude (scale S, G, O, P/V, N, N/O)
  ...
  reading_type VARCHAR(255) NULL COMMENT 'Varios valores separados por coma: en_desarrollo, silabica, fluida, etc.',
  comprehension_level VARCHAR(255) NULL COMMENT 'Varios valores separados por coma',
  writing_level VARCHAR(255) NULL COMMENT 'Varios valores separados por coma',
