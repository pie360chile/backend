...
CREATE TABLE IF NOT EXISTS `dynamic_form_submissions` (
  ...
  `specialty` varchar(255) DEFAULT NULL COMMENT 'Especialidad / área (ej. Fonoaudiología)',
  `respondent_name` varchar(255) DEFAULT NULL COMMENT 'Especialista o docente que responde',
  ...
  KEY `idx_dfs_form_student` (`dynamic_form_id`, `student_id`),
