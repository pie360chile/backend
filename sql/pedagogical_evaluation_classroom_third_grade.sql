...
-- Misma estructura que doc 32: 12 actitud, 15 lenguaje, 12 matemática; reading_type, comprehension_level, writing_level.
-- Ejecutar en la base de datos MySQL (pie360).

CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_third_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 33,
  ...
  -- IV. Lenguaje y comunicación (15 indicadores para 3º)
  ...
  reading_type VARCHAR(255) NULL COMMENT 'Varios valores separados por coma',
  ...
  -- V. Matem?tica (13 indicadores para 3?)
