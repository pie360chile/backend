-- Document 38 - Pauta de evaluacion pedagogica - Docente de aula - 1ero Medio (first year secondary).
-- Misma estructura que doc 34: 12 actitud, 17 lenguaje, 17 matematica; reading_type, comprehension_level, writing_level.
...
CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_first_grade_secondary (
  ...
  course VARCHAR(255) NULL COMMENT 'e.g. 1ero medio',
  ...
  -- IV. Lengua y literatura (13 indicadores para 1ero medio)
  ...
  -- V. Matematica (17 indicadores para 1ero medio)
