...
CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_seventh_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 37,
  ...
  course VARCHAR(255) NULL COMMENT 'e.g. 7mo basico',
