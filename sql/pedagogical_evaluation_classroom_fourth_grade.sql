...
-- Misma estructura que doc 33: 12 actitud, 15 lenguaje, 13 matematica; reading_type, comprehension_level, writing_level.
-- Ejecutar en la base de datos MySQL (pie360).

CREATE TABLE IF NOT EXISTS pedagogical_evaluation_classroom_fourth_grade (
  id INT AUTO_INCREMENT PRIMARY KEY,
  student_id INT NOT NULL,
  document_type_id INT NULL DEFAULT 34,
  ...
  course VARCHAR(255) NULL COMMENT 'e.g. 4to basico',
  ...
  -- IV. Lenguaje y comunicacion (17 indicadores para 4to)
  ...
  -- V. Matematica (17 indicadores para 4to)
