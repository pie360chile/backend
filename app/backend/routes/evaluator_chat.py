...
# Límite del contexto libre que escribe el usuario en POST /chat/evaluator (longitud del string en caracteres).
MAX_USER_CONTEXT_CHARS = 6000
...
class EvaluatorChatRequest(BaseModel):
    ...
    user_context: str = Field(
        ...
        description=(
            ...
            f"Máximo {MAX_USER_CONTEXT_CHARS} caracteres."
        ),
...
@evaluator_chat.post(
    ...
    description=(
        "Recibe `question` (instrucción/tarea) y `user_context` (texto libre del usuario; máximo 6000 caracteres). "
