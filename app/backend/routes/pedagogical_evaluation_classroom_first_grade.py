"""Router generado desde pedagogical_evaluation_registry — pedagogical_evaluation_classroom_first_grade."""
...
pedagogical_evaluation_classroom_first_grade = build_pedagogical_evaluation_router(
    prefix=_cfg.prefix,
    tag=_cfg.tag,
    model=_cfg.model,
