    ...
    def build_store_data_prompt_block(
        ...
        *,
        ...
        lines: list[str] = [
            ...
            "- APOYOS Y TRABAJO COLABORATIVO (campos `supports` y `collaborative_work`):",
            "  corresponden a «Trabajo colaborativo y apoyos educativos para la inclusión»",
            "  (aula regular, sala de recursos, comunidad educativa, articulación entre",
            "  profesionales/estamentos, etc.). Formato OBLIGATORIO:",
            "  • Lista numerada 1) 2) 3) 4)… o viñetas con guion (-).",
            "  • Mínimo 4 ítems distintos en CADA campo.",
            "  • Cada ítem: párrafo extenso y detallado (aprox. 40–80 palabras), con acción",
            "    concreta, quién participa, dónde se realiza y para qué sirve al estudiante.",
            "  • Prohibido un solo párrafo corrido o listas de una frase telegráfica.",
            "- ACUERDOS Y COMPROMISOS (campo `agreements` — escuela y familia):",
            "  Exactamente 3 viñetas (1 escuela, 2 familia, 3 compartida).",
            "  Cada ítem MUY extenso y detallado (aprox. 60–120 palabras): qué se acuerda,",
            "  quién, cómo, seguimiento y beneficio para el/la estudiante.",
